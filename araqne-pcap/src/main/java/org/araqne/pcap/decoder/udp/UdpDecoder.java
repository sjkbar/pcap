 ...
 */
package org.araqne.pcap.decoder.udp;
...
import org.araqne.pcap.decoder.ipv6.Ipv6Packet;
import org.araqne.pcap.decoder.ipv6.Ipv6Processor;
		...
		if (processors != null) {
			for (UdpProcessor processor : processors) {
				try {
					...
					logger.warn("araqne pcap: udp processor should now throw any exception", e);
				}
			}
		}
	}
