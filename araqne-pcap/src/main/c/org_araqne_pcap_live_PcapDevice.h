...
extern "C" {
#endif
#undef org_araqne_pcap_live_PcapDevice_MAX_NUMBER_OF_INSTANCE
#define org_araqne_pcap_live_PcapDevice_MAX_NUMBER_OF_INSTANCE 255L

/*
 * Class:     org_araqne_pcap_live_PcapDevice
 * Method:    getDeviceList
 * Signature: ()[Lorg/araqne/pcap/live/PcapDevice;
 */
JNIEXPORT jobjectArray JNICALL Java_org_araqne_pcap_live_PcapDevice_getDeviceList
  (JNIEnv *, jclass);
...
/*
 * Class:     org_araqne_pcap_live_PcapDeviceInputStream
 * Method:    getPacket
 ...
 */
JNIEXPORT jobject JNICALL Java_org_araqne_pcap_live_PcapDevice_getPcapLibVersion
  (JNIEnv *, jclass);
