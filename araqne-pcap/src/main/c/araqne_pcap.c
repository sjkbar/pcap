...
JNIEXPORT jobjectArray JNICALL Java_org_araqne_pcap_live_PcapDeviceManager_getDeviceList(JNIEnv *env, jclass cls) {
	jclass clzPcapDeviceMetadata = (*env)->FindClass(env, "org/araqne/pcap/live/PcapDeviceMetadata");
	jmethodID clzPcapDevice_init = (*env)->GetMethodID(env, clzPcapDeviceMetadata, "<init>", "(Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;Ljava/lang/String;[B[Lorg/araqne/pcap/live/AddressBinding;[BI)V");
	pcap_if_t *alldevs;
	pcap_if_t *dev;
...
JNIEXPORT void JNICALL Java_org_araqne_pcap_live_PcapDevice_open(JNIEnv *env, jobject obj, jint id, jstring name, jint snaplen, jboolean promisc, jint milliseconds) {
	char errbuf[PCAP_ERRBUF_SIZE];
...
JNIEXPORT void JNICALL Java_org_araqne_pcap_live_PcapDevice_setNonblock(JNIEnv *env, jobject obj, jint id, jint nonblock) {
	char errbuf[PCAP_ERRBUF_SIZE];
...
JNIEXPORT jboolean JNICALL Java_org_araqne_pcap_live_PcapDevice_isNonblock(JNIEnv *env, jobject obj, jint id) {
	char errbuf[PCAP_ERRBUF_SIZE];
	int status;
...
JNIEXPORT void JNICALL Java_org_araqne_pcap_live_PcapDevice_setFilter(JNIEnv *env, jobject obj, jint id, jstring filter, jint optimize, jint netmask) {
	char *filt = NULL;
...
JNIEXPORT jobject JNICALL Java_org_araqne_pcap_live_PcapDevice_getStat(JNIEnv *env, jobject obj, jint id) {
	jclass cPcapStat = (*env)->FindClass(env, "org/araqne/pcap/live/PcapStat");
...
JNIEXPORT void JNICALL Java_org_araqne_pcap_live_PcapDevice_close(JNIEnv *env, jobject obj, jint id) {
	pcap_t *temp = pcds[id];
...
JNIEXPORT jobject JNICALL Java_org_araqne_pcap_live_PcapDevice_getPcapLibVersion(JNIEnv *env, jclass cls) {
...
jobjectArray getAddressBindings(JNIEnv *env, pcap_if_t *dev) {
	jclass clzAddressBinding = (*env)->FindClass(env, "org/araqne/pcap/live/AddressBinding");
...
jobject makePacket(JNIEnv *env, struct pcap_pkthdr *header, const u_char *data) {
	jclass cPacket = (*env)->FindClass(env, "org/araqne/pcap/packet/PcapPacket");
	jmethodID pacMetId = (*env)->GetMethodID(env, cPacket, "<init>", "(Lorg/araqne/pcap/packet/PacketHeader;Lorg/araqne/pcap/packet/PacketPayload;)V");
...
jobject makePacketHeader(JNIEnv *env, struct pcap_pkthdr *header) {
	jclass cPacketHeader = (*env)->FindClass(env, "org/araqne/pcap/packet/PacketHeader");
...
jobject makePacketPayload(JNIEnv *env, const u_char *data, jint inclLen) {
	jclass cPacketPayload = (*env)->FindClass(env, "org/araqne/pcap/packet/PacketPayload");
