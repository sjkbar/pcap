...
#include <string.h>
#endif
#include "org_araqne_pcap_routing_RoutingTable.h"

#ifdef WIN32

JNIEXPORT jobject JNICALL Java_org_araqne_pcap_routing_RoutingTable_getNativeRoutingEntries(JNIEnv *env, jobject obj) {
...
jobject GetRoutingEntry(JNIEnv *env, MIB_IPFORWARDROW *row) {
	jclass clzRoutingEntry = (*env)->FindClass(env, "org/araqne/pcap/routing/RoutingEntry");
