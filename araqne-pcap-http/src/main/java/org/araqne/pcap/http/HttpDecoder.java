...
import org.araqne.pcap.http.impl.FlagEnum;
import org.araqne.pcap.http.impl.HttpRequestImpl;
import org.araqne.pcap.http.impl.HttpRequestState;
import org.araqne.pcap.http.impl.HttpResponseImpl;
import org.araqne.pcap.http.impl.HttpResponseState;
import org.araqne.pcap.http.impl.HttpSession;
import org.araqne.pcap.http.impl.PartialContentManager;
...
public class HttpDecoder implements TcpProcessor {
	...
	private void decodeContent(HttpResponseImpl response) {
		try {
			...
			if (logger.isDebugEnabled())
				logger.debug("araqne http decoder: cannot decode content", e);
		}
	}
